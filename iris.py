...
print("Training label:\n", label_train)# 60 row x 1 column (output --> actual input)
print("Validation label:\n", label_val)# 45 row x 1 column (output --> actual input)
print("Test Label:\n", label_test)# 45 row x 1 column (output --> actual input)
...
#to chek function to calculate accuracy
